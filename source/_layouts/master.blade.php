    ...
    <div class="container flex items-center max-w-8xl mx-auto px-4 lg:px-8">
        <div class="flex items-center">
            <a href="/" title="{{ $page->siteName }} home" class="inline-flex items-center">
                <h1 class="text-3xl my-0 pr-4"><span
                            class="text-4xl">{{ $page->emojiName }}</span> {{ $page->siteName }}</h1>
            </a>
        </div>
        ...
        <div class="hidden lg:flex lg:items-center lg:justify-between xl:w-1/4 px-6">
            <div class="flex justify-start items-center text-gray-500">
                <a class="block flex items-center hover:text-gray-700 mr-5"
                   href="https://github.com/phony-php/phony">
                ...
                <a class="block flex items-center hover:text-gray-700 mr-5" href="https://twitter.com/phonyphp">
                    <svg class="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <title>Twitter</title>
